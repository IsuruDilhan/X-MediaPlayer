/**
 * Created by Isuru 1 on 27/11/2015.
 */
function Xplayer(options) {
    ...
    '<div class="pull-left">'+
    //'<div class="pull-left"><label for="files"> <span class="btn-xs" style="border: 1px #fff solid;background: transparent;margin:0 10px;width: 0px ;height:25px ;padding-bottom:4px ;overflow:hidden;">Select Media</span></label>'+
    //'<input class="" style="visibility: hidden; position:absolute; "id="files" type="file" accept="*"/></div>'+
    '<div class="pull-left"><button class="px-video-restart"><span class="sr-only">Restart</span></button>' +
    ...
    '</div>' +
    '<div class="pull-left"><label for="files"> <span class="btn-xs" style="cursor: pointer;border: 1px #fff solid;background: transparent;margin:0 10px;width: 0px ;height:25px ;padding-bottom:4px ;overflow:hidden;">Select Media</span></label>'+
    '<input class="pull-left" style="visibility: hidden; position:absolute; "id="files" type="file" name="fileselect[]" multiple="multiple"/></div>'+
    ...
    '</div>' +
    '<div class="pull-left">' +
    '<label for="volume'+obj.randomNum+'" class="sr-only">Volume:</label><input id="volume'+obj.randomNum+'" class="px-video-volume" type="range" min="0" max="10" value="10" />' +
    '</div>' +
        ...
        var URL = win.URL || win.webkitURL,
            ...
            playSelectedFile = function playSelectedFileInit(event) {
              ...
              //  console.log(file.name);
                document.getElementById("media").innerHTML=file.name;
                document.getElementById("mediaT").innerHTML=file.name;
                var type = file.type;
    ...
    //input shortcut
     document.body.addEventListener('keyup', function(e) {
         if (event.keyCode == 83) document.getElementById('files').click();
     },false);
//playlistBuid
//    var nextVideo = "file:///C:/Users/Isuru%201/Desktop/Facebook.MP4";
//    var videoPlayer = document.getElementById('cont');
...
//    }
    ...
    //{obj.labelMuteOffset} was below before "px"
    obj.labelMute.setAttribute("style", "margin-left:" + "200" + "px");
